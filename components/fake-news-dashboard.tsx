...
export function FakeNewsDashboard() {
  ...
  return (
    <div className="signal-shell min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-[1440px] px-5 py-8 lg:px-8 lg:py-10">
        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.75fr)]">
          <section className="signal-panel signal-reveal signal-reveal-delay-1 overflow-hidden rounded-xl border border-border/80 bg-card/80 shadow-sm backdrop-blur-md" aria-labelledby="analyzer-title">
          ...
          <section className="signal-panel signal-reveal signal-reveal-delay-2 rounded-xl border border-border/80 bg-card/80 shadow-sm backdrop-blur-md" aria-labelledby="result-title">
